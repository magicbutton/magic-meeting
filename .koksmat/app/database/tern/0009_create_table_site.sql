...
(
    ...
    ,businesshours_id int   NOT NULL
                ...
                ON UPDATE NO ACTION
                ON DELETE NO ACTION
                NOT VALID;                ALTER TABLE IF EXISTS public.site
                ADD FOREIGN KEY (businesshours_id)
                REFERENCES public.businesshours (id) MATCH SIMPLE
                ON UPDATE NO ACTION
                ON DELETE NO ACTION
                NOT VALID;
