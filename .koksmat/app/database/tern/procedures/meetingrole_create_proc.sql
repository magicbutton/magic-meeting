...
CREATE OR REPLACE PROCEDURE proc.create_meetingrole(
...
BEGIN
    ...
    INSERT INTO public.meetingrole (
    id,
    created_at,
    updated_at,
        created_by, 
    ...
    RETURNING id INTO p_id;
       ...
       p_auditlog_params := jsonb_build_object(
        'tenant', '',
        'searchindex', '',
        'name', 'create_meetingrole',
        'status', 'success',
        'description', '',
        'action', 'create_meetingrole',
        'entity', 'meetingrole',
        'entityid', -1,
        'actor', p_actor_name,
        'metadata', p_params
