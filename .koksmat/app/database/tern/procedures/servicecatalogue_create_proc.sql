...
CREATE OR REPLACE PROCEDURE proc.create_servicecatalogue(
...
BEGIN
    ...
    INSERT INTO public.servicecatalogue (
    id,
    created_at,
    updated_at,
        created_by, 
    ...
    RETURNING id INTO p_id;
       ...
       p_auditlog_params := jsonb_build_object(
        'tenant', '',
        'searchindex', '',
        'name', 'create_servicecatalogue',
        'status', 'success',
        'description', '',
        'action', 'create_servicecatalogue',
