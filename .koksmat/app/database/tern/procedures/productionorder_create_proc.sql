...
CREATE OR REPLACE PROCEDURE proc.create_productionorder(
...
BEGIN
    ...
    INSERT INTO public.productionorder (
    id,
    created_at,
    updated_at,
        created_by, 
    ...
    RETURNING id INTO p_id;
       ...
       p_auditlog_params := jsonb_build_object(
        'tenant', '',
        'searchindex', '',
        'name', 'create_productionorder',
        'status', 'success',
        'description', '',
        'action', 'create_productionorder',
