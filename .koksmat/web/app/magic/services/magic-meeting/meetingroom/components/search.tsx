...
import MeetingRoomSmallCard from "./smallcard";
...
*/ 
    ...
    export default function SearchMeetingRoom(
        props: {
          onItemClick? : (item:MeetingRoomItem) => void
        }
              ...
              {searchResult?.data && (
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 ">
                  {searchResult.data.items.map((item, index) => {
                    ...
                    <MeetingRoomSmallCard item={item} 
