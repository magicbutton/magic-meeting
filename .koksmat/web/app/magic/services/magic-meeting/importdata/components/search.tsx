...
import ImportDataSmallCard from "./smallcard";
...
*/ 
    ...
    export default function SearchImportData(
        props: {
          onItemClick? : (item:ImportDataItem) => void
        }
