...
import MessageTemplateSmallCard from "./smallcard";
...
*/ 
    ...
    export default function SearchMessageTemplate(
        props: {
          onItemClick? : (item:MessageTemplateItem) => void
        }
              ...
              {searchResult?.data && (
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 ">
                  {searchResult.data.items.map((item, index) => {
                    ...
                    <MessageTemplateSmallCard item={item} 
