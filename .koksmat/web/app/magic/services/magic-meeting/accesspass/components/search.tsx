...
import AccessPassSmallCard from "./smallcard";
...
*/ 
    ...
    export interface Root {
        ...
        totalItems: number
        currentPage: number
        items: AccessPassItem[]
      }
   

    export default function SearchAccessPass(
        props: {
          onItemClick? : (item:AccessPassItem) => void
        }
