...
import ServiceOrderSmallCard from "./smallcard";
...
*/ 
    ...
    export default function SearchServiceOrder(
        props: {
          onItemClick? : (item:ServiceOrderItem) => void
        }
              ...
              {searchResult?.data && (
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 ">
                  {searchResult.data.items.map((item, index) => {
                    ...
                    <ServiceOrderSmallCard item={item} 
