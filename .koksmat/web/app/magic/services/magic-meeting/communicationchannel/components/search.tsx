...
import CommunicationChannelSmallCard from "./smallcard";
...
*/ 
    ...
    export default function SearchCommunicationChannel(
        props: {
          onItemClick? : (item:CommunicationChannelItem) => void
        }
              ...
              {searchResult?.data && (
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 ">
                  {searchResult.data.items.map((item, index) => {
                    ...
                    <CommunicationChannelSmallCard item={item} 
