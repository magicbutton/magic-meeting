...
import ServiceCatalogueSmallCard from "./smallcard";
...
*/ 
    ...
    export default function SearchServiceCatalogue(
        props: {
          onItemClick? : (item:ServiceCatalogueItem) => void
        }
              ...
              {searchResult?.data && (
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 ">
                  {searchResult.data.items.map((item, index) => {
                    ...
                    <ServiceCatalogueSmallCard item={item} 
