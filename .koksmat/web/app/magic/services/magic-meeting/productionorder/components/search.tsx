...
import ProductionOrderSmallCard from "./smallcard";
...
*/ 
    ...
    export default function SearchProductionOrder(
        props: {
          onItemClick? : (item:ProductionOrderItem) => void
        }
              ...
              {searchResult?.data && (
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 ">
                  {searchResult.data.items.map((item, index) => {
                    ...
                    <ProductionOrderSmallCard item={item} 
