...
import MeetingRoleSmallCard from "./smallcard";
...
*/ 
    ...
    export interface Root {
        ...
        totalItems: number
        currentPage: number
        items: MeetingRoleItem[]
      }
   

    export default function SearchMeetingRole(
        props: {
          onItemClick? : (item:MeetingRoleItem) => void
        }
              ...
              {searchResult?.data && (
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 ">
                  {searchResult.data.items.map((item, index) => {
                    ...
                    <MeetingRoleSmallCard item={item} 
